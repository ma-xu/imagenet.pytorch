...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/imagenet.pytorch/main.py -a se_resnet50 -b 256 --dist-url 'tcp://127.0.0.1:9998' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0  /home/xm0036/Datasets/ImageNet
